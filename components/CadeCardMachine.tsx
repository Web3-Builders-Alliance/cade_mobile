        ...
        >
          <View className="flex flex-row items-center ml-5">
            <View className="w-2/4">
              <Text
                style={{ fontSize: 26, fontFamily: "VT323-Regular", color: "white" }}
              >
                Cade Card Machine
              </Text>
            </View>
          ...
          <View className="items-center">
            <View className="mt-5">
              <Text
                style={{ fontFamily: "VT323-Regular", fontSize: 22, color: "white" }}
              >
                Payment Method :{" "}
                <Text
                  className="bg-black"
            ...
            <View style={{ bottom: 34 }}>
              <Text
                style={{ color: "white", fontFamily: "VT323-Regular", fontSize: 25 }}
              >
                No Transaction....
              </Text>
            </View>
        ...
        >
          ...
          >
            <View className="flex justify-center items-center ml-5">
              <Text
                style={{ fontFamily: "VT323-Regular", fontSize: 20, color: "white" }}
              >
                Select and Pay
              </Text>
            </View>
